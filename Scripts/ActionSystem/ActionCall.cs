...
There are several different types of calls:
    -ActionDynamicCall: Calls a given function dynamically with the given arguments. Much more moverhead than a normal call.
    -ActionCall: Calls the given function. Can take up to 4 arguments.
    -ActionReturnCall: Calls the given function and stores the return value. Can take up to 4 arguments.
